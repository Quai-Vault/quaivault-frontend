        ...
        <nav className="h-full px-6">
          <div className="flex justify-between h-full items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              {Number(import.meta.env.VITE_CHAIN_ID) === 9 && (
                <div
                  className="hidden sm:flex items-center gap-2 px-3 py-1 rounded-full bg-green-100 dark:bg-green-900/40 border border-green-300 dark:border-green-700/50"
                  title="Connected to Quai Mainnet."
                >
                  <span className="w-2 h-2 rounded-full bg-green-500 dark:bg-green-400 animate-pulse" aria-hidden="true" />
                  <span className="text-xs font-semibold text-green-700 dark:text-green-300">Quai Mainnet</span>
                </div>
              )}
              <NotificationToggle />
              <ThemeToggle />
