...
export const Sidebar = memo(function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  return (
    <>
      ...
      {collapsed && (
        <aside
          className="hidden lg:flex fixed left-0 top-14 bottom-0 w-16 bg-white dark:bg-vault-dark-2 border-r-2 border-dark-200 dark:border-dark-700 flex-col items-center z-40 py-3 gap-2"
      ...
      <aside className={`fixed left-0 top-14 bottom-0 w-64 bg-white dark:bg-vault-dark-2 border-r-2 border-dark-200 dark:border-dark-700 flex flex-col z-40 overflow-hidden transition-transform duration-300 ${collapsed ? '-translate-x-full lg:translate-x-0 lg:w-0 lg:border-r-0' : 'translate-x-0'}`}>
