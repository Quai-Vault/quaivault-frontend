        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              aria-busy={proposeSetupRecovery.isPending || undefined}
              className={`btn-primary w-full inline-flex items-center justify-center gap-2 ${proposeSetupRecovery.isPending ? 'btn-loading' : ''}`}
            >
