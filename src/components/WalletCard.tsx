      ...
      <div className="group">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-4 flex-1 min-w-0">
            ...
            {isDualRole && (
              <svg className="w-3.5 h-3.5 text-blue-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" role="img" aria-label="Also a guardian">
                {/* SVG tooltips come from a <title> child; a `title` attribute does nothing here. */}
                <title>Also a guardian</title>
