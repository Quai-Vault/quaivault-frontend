...
export const SocialRecoverySchema = z.object({
  ...
  expiration: z.number().nullable().default(0),
  ...
  cancelled_at_block: z.number().nullable(),
  cancelled_at_tx: z.string().nullable(),
  expired_at_block: z.number().nullable(),
  expired_at_tx: z.string().nullable(),
  invalidated_at_block: z.number().nullable(),
  invalidated_at_tx: z.string().nullable(),
  created_at: z.string(),
  updated_at: z.string(),
});
